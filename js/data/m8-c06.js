    ...
    },
    {
      ...
      content: {
        blocks: [
          ...
          { type: "reveal", label: "Voir la solution ft_print_params", code: "#include <unistd.h>\n\nvoid ft_putstr(char *str)\n{\n    int i;\n\n    i = 0;\n    while (str[i])\n    {\n        write(1, &str[i], 1);\n        i++;\n    }\n}\n\nint main(int argc, char **argv)\n{\n    int i;\n\n    i = 1;\n    while (i < argc)\n    {\n        ft_putstr(argv[i]);\n        write(1, \"\\n\", 1);\n        i++;\n    }\n    return (0);\n}", explanation: "On commence à i = 1 pour skip le nom du programme. On affiche chaque argument suivi d'un \\n." },
          ...
          { type: "reveal", label: "Voir la solution ft_rev_params", code: "int main(int argc, char **argv)\n{\n    int i;\n\n    i = argc - 1;\n    while (i > 0)\n    {\n        ft_putstr(argv[i]);\n        write(1, \"\\n\", 1);\n        i--;\n    }\n    return (0);\n}", explanation: "On part du dernier (argc - 1) et on descend jusqu'à 1. On ne va pas jusqu'à 0 car c'est le nom du programme." },
    ...
    },
    {
      ...
      content: {
        blocks: [
          ...
          { type: "reveal", label: "Voir la solution ft_sort_params", code: "int ft_strcmp(char *s1, char *s2)\n{\n    int i;\n\n    i = 0;\n    while (s1[i] && s2[i] && s1[i] == s2[i])\n        i++;\n    return (s1[i] - s2[i]);\n}\n\nint main(int argc, char **argv)\n{\n    int i;\n    int sorted;\n    char *tmp;\n\n    sorted = 0;\n    while (!sorted)\n    {\n        sorted = 1;\n        i = 1;\n        while (i < argc - 1)\n        {\n            if (ft_strcmp(argv[i], argv[i + 1]) > 0)\n            {\n                tmp = argv[i];\n                argv[i] = argv[i + 1];\n                argv[i + 1] = tmp;\n                sorted = 0;\n            }\n            i++;\n        }\n    }\n    i = 1;\n    while (i < argc)\n    {\n        ft_putstr(argv[i]);\n        write(1, \"\\n\", 1);\n        i++;\n    }\n    return (0);\n}", explanation: "Phase 1 : bubble sort sur les pointeurs argv avec ft_strcmp. Phase 2 : affichage classique. On échange des pointeurs (char *), pas des strings entières." },
