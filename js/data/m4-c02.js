    ...
    },
    {
      ...
      content: {
        blocks: [
          ...
          { type: "reveal", label: "Voir la solution ft_str_is_numeric", code: "#include <stdio.h>\n\nint ft_str_is_numeric(char *str)\n{\n    int i;                     // Index de parcours\n\n    i = 0;                     // Commence au debut\n    while (str[i])             // Parcourt chaque caractere\n    {\n        if (!(str[i] >= '0' && str[i] <= '9')) // Si pas un chiffre\n            return (0);        // Retourne 0 immediatement\n        i++;                   // Passe au suivant\n    }\n    return (1);                // Tous les chars sont des chiffres (ou vide)\n}\n\n// --- Test (a retirer avant de rendre) ---\nint main(void)\n{\n    printf(\"%d %d %d\\n\", ft_str_is_numeric(\"42\"), ft_str_is_numeric(\"42abc\"), ft_str_is_numeric(\"\"));\n    return (0);\n}", compileCmd: "gcc -Wall -Wextra -Werror ft_str_is_numeric.c -o test && ./test", expectedOutput: "101", explanation: "Même pattern : parcourir, tester, retourner 0 au premier caractère invalide. Return 1 si tous sont des chiffres." },
    ...
    },
    {
      ...
      content: {
        blocks: [
          ...
          { type: "reveal", label: "Voir la solution ft_str_is_lowercase", code: "#include <stdio.h>\n\nint ft_str_is_lowercase(char *str)\n{\n    int i;                     // Index de parcours\n\n    i = 0;                     // Commence au debut\n    while (str[i])             // Parcourt chaque caractere\n    {\n        if (!(str[i] >= 'a' && str[i] <= 'z')) // Si pas une minuscule\n            return (0);        // Retourne 0 immediatement\n        i++;                   // Passe au suivant\n    }\n    return (1);                // Tous les chars sont des minuscules (ou vide)\n}\n\n// --- Test (a retirer avant de rendre) ---\nint main(void)\n{\n    printf(\"%d %d %d\\n\", ft_str_is_lowercase(\"hello\"), ft_str_is_lowercase(\"Hello\"), ft_str_is_lowercase(\"\"));\n    return (0);\n}", compileCmd: "gcc -Wall -Wextra -Werror ft_str_is_lowercase.c -o test && ./test", expectedOutput: "101", explanation: "Seul le test change : on ne vérifie que la plage 'a'-'z'. Le reste du pattern est identique." },
          ...
          { type: "reveal", label: "Voir la solution ft_str_is_uppercase", code: "#include <stdio.h>\n\nint ft_str_is_uppercase(char *str)\n{\n    int i;                     // Index de parcours\n\n    i = 0;                     // Commence au debut\n    while (str[i])             // Parcourt chaque caractere\n    {\n        if (!(str[i] >= 'A' && str[i] <= 'Z')) // Si pas une majuscule\n            return (0);        // Retourne 0 immediatement\n        i++;                   // Passe au suivant\n    }\n    return (1);                // Tous les chars sont des majuscules (ou vide)\n}\n\n// --- Test (a retirer avant de rendre) ---\nint main(void)\n{\n    printf(\"%d %d %d\\n\", ft_str_is_uppercase(\"HELLO\"), ft_str_is_uppercase(\"Hello\"), ft_str_is_uppercase(\"\"));\n    return (0);\n}", compileCmd: "gcc -Wall -Wextra -Werror ft_str_is_uppercase.c -o test && ./test", expectedOutput: "101", explanation: "On ne garde que la plage 'A'-'Z'. Même structure, seules les bornes changent." },
          ...
          { type: "reveal", label: "Voir la solution ft_str_is_printable", code: "#include <stdio.h>\n\nint ft_str_is_printable(char *str)\n{\n    int i;                     // Index de parcours\n\n    i = 0;                     // Commence au debut\n    while (str[i])             // Parcourt chaque caractere\n    {\n        if (!(str[i] >= 32 && str[i] <= 126)) // Si hors plage imprimable\n            return (0);        // Retourne 0 immediatement\n        i++;                   // Passe au suivant\n    }\n    return (1);                // Tous les chars sont imprimables (ou vide)\n}\n\n// --- Test (a retirer avant de rendre) ---\nint main(void)\n{\n    printf(\"%d %d\\n\", ft_str_is_printable(\"Hello 42!\"), ft_str_is_printable(\"\"));\n    return (0);\n}", compileCmd: "gcc -Wall -Wextra -Werror ft_str_is_printable.c -o test && ./test", expectedOutput: "101", explanation: "Caractères imprimables : de l'espace (32) au tilde (126). Le \\t (9), \\n (10) et DEL (127) ne sont PAS imprimables." },
